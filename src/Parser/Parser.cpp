#include "catm/Parser/Parser.h"
#include "catm/Lex/Lexer.h"
#include "catm/Lex/Token.h"
#include "catm/Parser/ASTNode.h"
#include <iostream>
...
/// Hack: Definition tools in the Parser.
/// TODO.

void catm::Parser::HandleDefinition() {
    if (ParseDefinition()) {
...
void catm::Parser::HandleTopLevelExpression() {
...
// Hack: Used the main function to init tools.
void catm::Parser::Parse() {
    BinopPrecedence['<'] = 10;
    BinopPrecedence['+'] = 20;
    BinopPrecedence['-'] = 20;
...
int main(void) {
    catm::Lexer lexer(std::cin);
    catm::Parser parser(lexer);
    parser.Parse();
    return 0;
}
