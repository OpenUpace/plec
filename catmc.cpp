...
static std::unordered_map<std::string, Token> keywords = {
    {"int", tok_int},       {"return", tok_return}, {"pub", tok_pub},
    {"module", tok_module}, {"unit", tok_unit},     {"use", tok_use},
...
int main() {
    ...
    auto G = cantFail(DynamicLibrarySearchGenerator::GetForCurrentProcess(
